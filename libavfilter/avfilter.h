...
#define AVFILTER_GET_BUFREF_AUDIO_PROPS(props_ptr, ref) {\
    assert(ref->type == AVMEDIA_TYPE_AUDIO);\
    props_ptr = (AVFilterBufferRefAudioProps *)ref->props;\
}
...
static inline void avfilter_copy_bufref_props(AVFilterBufferRef *dst, AVFilterBufferRef *src)
{
    ...
    {
       AVFilterBufferRefAudioProps *src_props, *dst_props;
       AVFILTER_GET_BUFREF_AUDIO_PROPS(src_props, src);
       AVFILTER_GET_BUFREF_AUDIO_PROPS(dst_props, dst);
       *dst_props = *src_props;
    }
    }
}
